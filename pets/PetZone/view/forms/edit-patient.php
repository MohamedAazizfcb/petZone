        ...
        <div class = "form-container">
          ...
          <div class="field input" hidden>
           ...
           <div class="field input">
            ...
            <input type ="text" name = "petname" id="petname" required value="<?php echo $_GET['petname']?>" minlength="8">
          </div>

          <div class="field input">
              <label for="species"> Species</label>
              <input type = "text" name = "species" id = "species" required value="<?php echo $_GET['species']?>" minlength="8">
           </div> 
