...
<div class ="container">
        <div class = "form-container">
          ...
          <div class="field input">
            ...
            <input type ="text" name = "firstname" value="<?php echo $_GET['firstname']?>" id="first name" required minlength="8">
          </div>

          <div class="field input">
            <label for="Last name">Last name</label>
            <input type ="text" name = "lastname" value="<?php echo $_GET['lastname']?>" id="Last name" required minlength="8">
          </div>
          ...
          <div class="field input">
            ...
            <div class="field input">
              ...
              <input type ="text" name = "password" value="<?php echo $_GET['password']?>" id="password" required minlength="8">
           </div>
