...
<div class ="container">
        <div class = "form-container">
          ...
          <div class="field input">
            ...
            <input type ="text" name = "firstname" value="<?php echo $_SESSION['firstname']?>" id="first name" required minlength="8">
          </div>

          <div class="field input">
            <label for="Last name">Last name</label>
            <input type ="text" name = "lastname" value="<?php echo $_SESSION['lastname']?>" id="Last name" required minlength="8">
          </div>
          ...
          <div class="field input">
            ...
            <div class="field input">
              ...
              <input type ="text" minlength="8" name = "password" value="<?php echo $_SESSION['password']?>" id="password" required >
           </div>
